...
{
    Gdiplus::Color colorMain(0xFF,0xFF, 0x00, 0x00);
    Bitmap bmp(L"name.bmp");
    ...
    graphics.DrawImage(&bmp, (INT)(rect.right - rect.left - width) / 2, rect.bottom - height, square.left, square.top, width, height, UnitPixel);
}
